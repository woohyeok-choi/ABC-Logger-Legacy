...
import kaist.iclab.abc.foreground.dialog.SurveyPreviewDialogFragment
import kaist.iclab.abc.foreground.view.*
...
object ViewUtils {
    ...
    fun bindParticipationInfo(view: View, entity: ParticipationEntity, fragmentManager: FragmentManager? = null) {
