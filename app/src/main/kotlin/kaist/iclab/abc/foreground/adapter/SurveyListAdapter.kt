...
import kaist.iclab.abc.common.EmptyEntityException
...
import kaist.iclab.abc.data.entities.SurveyEntity_
import kaist.iclab.abc.foreground.fragment.SurveyListFragment
...
class SurveyListAdapter : PagedListAdapter<SurveyEntity, SurveyListAdapter.ViewHolder>(DIFF_CALLBACK) {
    companion object {
        ...
        fun getEntityViewModel(fragment: Fragment, showOnlyUnread: Boolean) : EntityViewModel {
