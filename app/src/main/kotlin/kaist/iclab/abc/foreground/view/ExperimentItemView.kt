package kaist.iclab.abc.foreground.view
...
class ExperimentItemView(context: Context, attributeSet: AttributeSet?) : RelativeLayout(context, attributeSet) {
    ...
    fun bindView(basic: ExperimentProtos.ExperimentBasic?, constraint: ExperimentProtos.ExperimentConstraint?) {
    ...
    fun bindView(experiment: ExperimentProtos.ExperimentEssential? = null) {
