...
import kaist.iclab.abc.foreground.dialog.SimpleMessageDialogFragment
import kaist.iclab.abc.foreground.dialog.YesNoDialogFragment
import kaist.iclab.abc.foreground.view.DataView
...
class ParticipatedExperimentFragment : BaseFragment() {
    ...
    private lateinit var essential: MutableLiveData<Pair<ExperimentProtos.ExperimentBasic, ExperimentProtos.ExperimentConstraint>>
    private lateinit var participation: MutableLiveData<ParticipationEntity>
    private lateinit var experimenter: MutableLiveData<ExperimentProtos.Experimenter>
    ...
    private fun loadParticipatedExperiment() {
        ...
        Tasks.call(executor, Callable {
            ...
            val experiment = GrpcApi.getExperiment(entity.experimentUuid)
    ...
    private fun dropOut() {
        ...
        Tasks.call(executor, Callable {
            ...
            val experiment = GrpcApi.getExperiment(entityServer.experimentUuid)
