...
import kaist.iclab.abc.common.util.ViewUtils
...
class ExperimentParticipationActivity : BaseAppCompatActivity(),
    ...
    fun requestNextStep(fragment: Fragment) {
        ...
        ViewUtils.showPermissionDialog(this, requiredPermissions,
            {
                ...
                Tasks.call(executor, Callable {
                    ...
                    if(intent.getBooleanExtra(EXTRA_REQUIRES_GOOGLE_FITNESS, false)) GoogleFitnessCollector.subscribeFitnessData(this).continueWith { _ -> } else Tasks.call {  }
    ...
    companion object {
        ...
        fun newIntent(context: Context, experiment :ExperimentProtos.ExperimentFull) : Intent = Intent(context, ExperimentParticipationActivity::class.java)
